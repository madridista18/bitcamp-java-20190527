...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //   "Spring IoC 컨테이너"!
    LessonHandler lessonHandler = new LessonHandler(input, new ArrayList<Lesson>());
    MemberHandler memberHandler = new MemberHandler(input, new LinkedList<Member>());
    BoardHandler boardHandler = new BoardHandler(input, new ArrayList<Board>());
    
    
    BoardHandler boardHandler2 = new BoardHandler(input, new LinkedList<Board>());
