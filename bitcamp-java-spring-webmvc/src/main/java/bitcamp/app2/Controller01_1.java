...
public class Controller01_1 {
  ...
  // 테스트:
  //   http://localhost:8888/java-spring-webmvc/app2/c01_1/h1
  @GetMapping("h1") 
  ...
  public String handler1(Model model) {
    ...
    // 웹 애플리케이션이 경로가 '/bitcamp-java-spring-wermvc라면, JSP 경로는 다음과 같다. 
    //   /bitcamp-java-spring-webmvc/jsp/c01_1.jsp
  }

  // 테스트:
  //   http://localhost:8888/java-spring-webmvc/app2/c01_1/h2
  @GetMapping("h2") 
  ...
  // 테스트:
  //   http://localhost:8888/java-spring-webmvc/app2/c01_1/h3
  @GetMapping("h3") 
  public String handler3(HashMap<String,Object> map) {
