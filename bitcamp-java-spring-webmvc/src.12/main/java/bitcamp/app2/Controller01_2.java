// 기본 View Resolver 교체하기 - IntenalResourceViewResolver 사용하기 
...
public class Controller01_2 {
  ...
  // 테스트:
  //   http://localhost:8888/java-spring-webmvc/app2/c01_2/h1
  @GetMapping("h1") 
  public String handler1(Map<String,Object> map) {
    ...
    //      "c01_1/h1"
    //    최종 JSP URL은 
    //      "/WEB-INF/jsp2/c01_2/h1.jsp"가 된다.
    //
    return "c01_2/h1";
  }
  ...
  public ModelAndView handler5() {
    ...
    // 프론트 컨트롤러는 ModelAndView 객체에 보관되어 있는 값들을
    // ServletRequest 보관소로 옮기고, 
    // 뷰 이름을 지정하지 않으면 request handler의 설정된 뷰 이름을 ViewResolver 에게 넘긴다. 
    return mv;
  }
}
