...
public class RequestMappingHandlerMapping {
  ...
  public static class RequestHandler {
    ...
    private List<String> getParameterNames(Class<?> type, Method method) 
      ...
      // => 그러나 .class 파일에는 분명히 파라미터 이름이 들어있다.
    ...
    private Object getPojoValue(String paramName, Class<?> paramType, HttpServletRequest request) throws Exception {
      ...
      for (Method m : methods) {
       ...
       log.debug(".........." + propName);
        ...
        // 셋터에 넘겨줄 값을 준비하지 못했으면 다음 메서드로 넘어간다. 
          if (value == null) 
            continue;
    ...
    private Object getPrimitiveValue(
      ...
      if (paramType == byte.class || paramType == Byte.class) 
        ...
        return java.sql.Date.valueOf(value); // 문자열 형식: "yyyy-MM-dd"이어야한다. 
      return value;
    }
