// v59_2 : WebApplicationInitializer 를 사용하여 DispatcherServlet 배치하기  
package com.eomcs.lms;

// 작업:
// => com.eomcs.lms.controller를 com.eomcs.lms.web 으로 패키지명 변경 
...
//    - ContextLoaderListener가 사용하는 컨텍스트 파라미터 정보 제거 
